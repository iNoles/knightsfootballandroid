...
/**
 * Sports navigation bar item with icon and label content slots. Wraps Material 3
 * [NavigationBarItem].
 *
...
/**
 * Sports navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
...
/**
 * Sports navigation rail item with icon and label content slots. Wraps Material 3
 * [NavigationRailItem].
 *
 * @param selected Whether this item is selected.
 * @param onClick The callback to be invoked when this item is selected.
...
/**
 * Sports navigation rail with header and content slots. Wraps Material 3 [NavigationRail].
 *
...
/**
 * Sports navigation default values.
 */
